...
require_once dirname(__DIR__) . "/move_strategies/MoveStrategy.php";
...
class Controller implements GameStatus, ResolutionSelection {
    ...
    private function setupGame() {
        ...
        while ($resolutionSelection === ResolutionSelection::RETRY) {
            ...
            // Calls new/index.php
            $newResult = $this->model->getNew($this->view->promptStrategy($info->getStrategies()));
    ...
    private function playGame() {
        ...
        while ($resolutionSelection === ResolutionSelection::RETRY) {
            ...
            $play = $this->model->getPlay($slot, $this->board->getWidth(), $this->board->getColHeights());
            if ($play->isError()) {
