 ...
 *                          opponent cannot make two more moves. (Not implemented)
 * ONE_FALL_THROUGH - one in a row, but not currently possible to add three more. (Not implemented)
 *
...
class Precedence {
    ...
    // TWO_BLOCK_FALL_THROUGH = 2 - Not implemented, but could be in future versions.
    // ONE_FALL_THROUGH = 1 - Not implemented, but could be in future versions.
    public const NONE = 0;
